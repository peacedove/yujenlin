...
<a href="{{ site.baseurl }}/images/halve-home-image.png"><img src="{{ site.baseurl }}/images/halve-home-image.png" alt="Home Page of Halve"></a>  
...
{% capture images %}
	{{ site.baseurl }}/images/halve-home-image.png
	{{ site.baseurl }}/images/post-image-halve-1.png
	{{ site.baseurl }}/images/post-image-halve-2.png
{% endcapture %}
{% include gallery images=images caption="Screenshots of Halve Theme" cols=3 %}

{% capture images %}
	{{ site.baseurl }}/images/post-image-halve-3.png
	{{ site.baseurl }}/images/post-image-halve-6.png
	{{ site.baseurl }}/images/post-image-halve-4.png
{% endcapture %}
...
```    
 ...
 ![Halve Twitter Card]({{ site.baseurl }}/images/post-image-halve-5.png)
